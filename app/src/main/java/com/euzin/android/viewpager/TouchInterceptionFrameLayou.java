 ...
 */
public class TouchInterceptionFrameLayou extends FrameLayout {
    ...
    public TouchInterceptionFrameLayou(Context context) {
        super(context);
    }

    public TouchInterceptionFrameLayou(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public TouchInterceptionFrameLayou(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public TouchInterceptionFrameLayou(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
